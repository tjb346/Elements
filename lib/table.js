...
export class Row extends DraggableMixin(DroppableMixin(BaseRow)) {
    ...
    handleDragStart(event) {
        ...
        if (event.dataTransfer) {
            event.dataTransfer.setData(this.constructor.dataTransferType, JSON.stringify(this.data));
...
export class Data extends TableElement {
    ...
    toggleSortOrder() {
        ...
        this.classList.remove(this.constructor.ascendingSortClass, this.constructor.descendingSortClass);
        if (next !== null) {
