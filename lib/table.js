...
export class Data extends TableElement {
    ...
    toggleSortOrder() {
        let next = this.ascendingSortClass;
        if (this.classList.contains(this.ascendingSortClass)) {
        ...
        this.classList.remove(this.ascendingSortClass, this.descendingSortClass);
        if (next !== null) {
...
export class Table extends DroppableMixin(ScrollWindowElement) {
    constructor() {
        super();
        this.headerContainerClass = 'header';
        this.showHiddenClass = 'show-hidden';
        this.sortStack = [];
